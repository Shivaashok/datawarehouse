...
combined_data <- data.frame(Class = c(rep("A", length(classA)), rep("B",
length(classB))),
...
cat("- Class A's distribution appears to be skewed towards higher scores, while Class
B's distribution is more symmetric.\n")
cat("- Class A has a higher median and a more spread-out interquartile range
compared to Class B.\n")